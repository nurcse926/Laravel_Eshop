...
$data['category_description']=$request->catagory_description;
...
public function update_category(Request $request, $category_id){
	...
	Session::put('message','Cetegory update is Successfully!!!');
...
public function delete_category($category_id){
	...
	Session::put('message','Cetegory Delete is Successfully!!!');
	return Redirect('/all-category');
}
