...
<head>
	...
	<meta name="author" content="Anindya Nur">
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{url('/dashboard')}}"><span style="color:#8e3c0c; font-family:Poiret One">Fashi&hearts;n<i style="color: green">C</i>loud</span></a>				
				<!-- start: Header Menu -->
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/add-category')}}"><i class="icon-list-ul"></i><span class="hidden-tablet"> Add Category</span></a></li>
						...
						<li><a href="{{URL::to('/order-manage')}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> Order Manage</span></a></li>
	...
	<footer>
		<p>
			<span style="text-align:left;float:left">&copy; 2018 <a href="http://bootstrapmaster.com/" alt="Bootstrap Themes">Fashi&hearts;n Cloud || All Reserved Fashi&hearts;n CLoud</a></span>
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="http://admintemplates.co/" alt="Bootstrap Admin Templates"><span style="color:gray">Fashi&hearts;n Cloud</span></a></span>
		</p>
	</footer>
	<!-- start: JavaScript-->
