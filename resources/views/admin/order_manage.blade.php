			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span><b>Order Details</b></h2>
						<div class="box-icon">
							...
							<tr>
								...
								@if($v_order->order_status==1)
							       ...
							       @if($v_order->order_status==1)
									...
									@endif
									<a class="btn btn-info" href="{{URL::to('/order-details')}}">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" onclick="return confirm('Are you sure delete?')" 
									 href="{{URL::to('/delete-order/'.$v_order->order_id)}}">
