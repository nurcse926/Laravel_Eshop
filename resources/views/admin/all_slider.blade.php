			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span><b>All Slider</b></h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<td><img src="{{URL::to($v_slider->slider_image)}}" style="height: 80px; width:300px; border:1px solid #99CC99">
								...
								@endif
							       ...
							       @if($v_slider->publication_status==1)
									...
									<a class="btn btn-danger" onclick="return confirm('Are you sure delete?')" 
									 href="{{URL::to('/delete_slider/'.$v_slider->slider_id)}}">
